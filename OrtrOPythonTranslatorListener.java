...
public class OrtrOPythonTranslatorListener extends PythonPrettyPrinterListener { // Extends GrammarNameBaseListener
    ...
    public static void main(String[] args) throws IOException {
        ...
        OrtrOPythonTranslatorListener listener = new OrtrOPythonTranslatorListener(); // main listener
