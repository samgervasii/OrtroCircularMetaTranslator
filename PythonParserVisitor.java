...
public interface PythonParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code rev_func_def_stmt}
	 * labeled alternative in {@link PythonParser#compound_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitRev_if(PythonParser.Rev_ifContext ctx);
	/**
	 * Visit a parse tree produced by the {@code rev_for}
	 * labeled alternative in {@link PythonParser#rev_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRev_for(PythonParser.Rev_forContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#rev_block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRev_block(PythonParser.Rev_blockContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#rev_suite}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRev_suite(PythonParser.Rev_suiteContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#rev_return}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRev_return(PythonParser.Rev_returnContext ctx);
	/**
	 * Visit a parse tree produced by the {@code suite_in_line}
	 * labeled alternative in {@link PythonParser#suite}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSuite_in_line(PythonParser.Suite_in_lineContext ctx);
	/**
	 * Visit a parse tree produced by the {@code suite_new_line}
	 * labeled alternative in {@link PythonParser#suite}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSuite_new_line(PythonParser.Suite_new_lineContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#rev_else}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRev_else(PythonParser.Rev_elseContext ctx);
	/**
