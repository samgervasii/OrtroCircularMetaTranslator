...
public interface PythonParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code rev_return}
	 * labeled alternative in {@link PythonParser#rev_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#rev_op}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRev_op(PythonParser.Rev_opContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code rev_func}
	 * labeled alternative in {@link PythonParser#funcdef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
